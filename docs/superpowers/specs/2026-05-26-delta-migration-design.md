...
- **Linux**: Add `asdf plugin add delta` to `run_once_before_00_install_packages.sh.tmpl` and add `delta 0.19.2` to `dot_tool-versions`. This ensures parity across platforms using the existing `asdf` setup.
